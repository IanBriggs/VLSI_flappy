...
set target_library [list Lib6710_Personal.db]
...
set myFiles [list BACKGROUND_VGA.v]
set fileFormat verilog    ;# verilog or VHDL
set basename BACKGROUND_VGA ;# Top-level module name
set myClk no_clock_needed         ;# The name of your clock 
